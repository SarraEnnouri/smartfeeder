...
class AnimalListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Colors.white, // Fond général de la page
      body: Container(
        color: Colors.white, // Fond spécifique du body
        child: Padding(
                                  ...
                                  PopupMenuButton<String>(
                                    ...
                                    onSelected: (value) {
                                      if (value == 'edit') {
                                        ...
                                        _showDeleteConfirmationDialog(context, animal.id);
                                      }
                                    },
  ...
  void _showDeleteConfirmationDialog(BuildContext context, String animalId) {
    showDialog(
      context: context,
